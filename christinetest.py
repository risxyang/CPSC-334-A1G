...
class Communicate(QObject):
    updateOrientation = pyqtSignal(str)
...
class Window2(QMainWindow):                           # <===
    ...
    def right_up(self):
        message = "Desktop-Right is Projector-Space-Up"
        print(message)

    def left_up(self):
        message = "Desktop-Left is Projector-Space-Up"
        print(message)
        self.c.updateOrientation.emit(message)

    def up_up(self):
        message = "Desktop-Up is Projector-Space-Up"
        print(message)
        self.c.updateOrientation.emit(message)

    def down_up(self):
        message = "Desktop-Down is Projector-Space-Up"
        print(message)
        self.c.updateOrientation.emit(message)
...
class Window(QMainWindow):
    ...
    def initUI(self):
        ...
        self.c = Communicate()
        self.c.updateOrientation.connect(self.lineEntry2)
